...
At present, for disease diagnosis tasks in neurosurgery, we have released NRAG, an instruction-tuned LLM specifically optimized for neurosurgical diagnosis applications. Please refer to the [[URL](https://github.com/thy0621/NRAG)](https://github.com/thy0621/NRAG) for the new version.
